export type SmartWallet = {
	version: '0.11.1';
	name: 'smart_wallet';
	docs: ['Goki smart wallet program.'];
	instructions: [
		{
			...
			accounts: [
				{
					...
					isMut: false;
					isSigner: true;
					docs: ['Base key of the SmartWallet.'];
				},
				{
					name: 'smartWallet';
					isMut: true;
					isSigner: false;
					docs: ['The [SmartWallet] to create.'];
					pda: {
						seeds: [
							{
								kind: 'const';
				...
				},
				{
					...
					isMut: true;
					isSigner: true;
					docs: ['Payer to create the smart_wallet.'];
				},
				{
					name: 'systemProgram';
					isMut: false;
		...
		},
		{
			...
			accounts: [
				...
				},
				{
					...
					isMut: true;
					isSigner: true;
					docs: ['Payer to create the [Transaction].'];
				},
				{
					name: 'systemProgram';
					isMut: false;
		...
		},
		{
			...
			docs: ['Creates a new [Transaction] account with time delay.'];
			accounts: [
				{
					name: 'smartWallet';
					isMut: true;
		...
		},
		{
			...
			accounts: [
				...
				},
				{
					...
					isMut: false;
					isSigner: true;
					docs: ['One of the smart_wallet owners. Checked in the handler.'];
				}
			];
			args: [];
		},
		...
		},
		{
			...
			accounts: [
				...
				},
				{
					...
					isMut: false;
					isSigner: true;
					docs: ['An owner of the [SmartWallet].'];
				}
			];
			args: [];
		},
			...
			accounts: [
				{
					...
					isMut: true;
					isSigner: false;
					docs: ['The [SubaccountInfo] to create.'];
					pda: {
						seeds: [
							{
								kind: 'const';
				...
				},
				{
					...
					isMut: true;
					isSigner: true;
					docs: ['Payer to create the [SubaccountInfo].'];
				},
				{
					name: 'systemProgram';
					isMut: false;
	...
	accounts: [
		{
			...
			type: {
				...
				fields: [
					{
						name: 'base';
						docs: ['Base used to derive.'];
						type: 'publicKey';
					},
					{
						name: 'bump';
						docs: ['Bump seed for deriving PDA seeds.'];
						type: 'u8';
					},
					{
						name: 'threshold';
					...
					{
						name: 'minimumDelay';
						docs: ['Minimum delay between approval and execution, in seconds.'];
						type: 'i64';
					},
					{
						name: 'gracePeriod';
						docs: ['Time after the ETA until a [Transaction] expires.'];
						type: 'i64';
					},
					{
						name: 'ownerSetSeqno';
					...
					},
					{
						...
						docs: ['Total number of [Transaction]s on this [SmartWallet].'];
						type: 'u64';
					},
					{
						name: 'owners';
						docs: ['Owners of the [SmartWallet].'];
						type: {
							vec: 'publicKey';
						};
					},
					{
						name: 'reserved';
						docs: ['Extra space for program upgrades.'];
						type: {
							array: ['u64', 16];
						};
					}
		...
		},
		{
			...
			type: {
				...
				fields: [
					{
						name: 'smartWallet';
						docs: ['The [SmartWallet] account this transaction belongs to.'];
						type: 'publicKey';
					},
					{
						name: 'index';
					...
					{
						name: 'executor';
						docs: ['The account that executed the [Transaction].'];
						type: 'publicKey';
					},
					{
						name: 'executedAt';
						docs: ['When the transaction was executed. -1 if not executed.'];
						type: 'i64';
					}
				];
			};
		...
		{
			name: 'subaccountInfo';
			docs: ['Mapping of a Subaccount to its [SmartWallet].'];
			type: {
				kind: 'struct';
				fields: [
					{
						name: 'smartWallet';
						docs: ['Smart wallet of the sub-account.'];
						type: 'publicKey';
					},
					{
						name: 'subaccountType';
						docs: ['Type of sub-account.'];
						type: {
							defined: 'SubaccountType';
						};
					},
	...
	types: [
		...
		{
			name: 'TXAccountMeta';
			docs: ['Account metadata used to define [TXInstruction]s'];
			type: {
				kind: 'struct';
				fields: [
					{
