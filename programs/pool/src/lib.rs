...
//     use crate::{instruction::DepositLiquidity, instructions::CreatePool};
...
//     /// * ctx - initialize the manager
//     ///
//     pub fn initialize_policy_holder(ctx: Context<InitializePoolManager>) -> Result<()> {
...
//                     mint: ctx
//                         .accounts
//                         .liquidity_position_nft_mint
//                         .to_account_info()
//                         .clone(),
//                     to: ctx
//                         .accounts
//                         .liquidity_position_nft_account
//                         .to_account_info()
//                         .clone(),
...
//         let liquidity_tick_info_state = AccountLoader::<tick::Tick>::try_from(
//             &ctx.accounts.liquidity_tick_info.to_account_info(),
//         )?;
...
//         let tick_account_state = AccountLoader::<tick::Tick>::try_from(
//             &ctx.accounts.liquidity_tick_info.to_account_info(),
//         )?;
